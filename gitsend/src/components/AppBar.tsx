...
import brand3 from '../assets/newbrand.png';
import brand4 from '../assets/newbrand1x1.png';
...
export const AppBar: React.FC = () => {
  ...
  return (
    <div>
      {/* NavBar / Header */}
      <div className="navbar flex h-20 flex-row md:mb-2  text-neutral-content ">
        <div className="navbar-start align-items-center">
          <div className="hidden sm:inline w-22 h-22 md:p-2 ml-10">
            <Image src={brand3} alt="Brand Logo" className="brand-logo" />
          </div>
          <div className="sm:hidden w-22 h-22 md:p-2 ml-10">
            <Image src={brand4} alt="Brand Logo Mobile" className="brand-logo2" />
          </div>
          <WalletMultiButtonDynamic className="button btn-sm  relative flex md:hidden text-lg " />
        </div>
        ...
        <div className="navbar-end">
          ...
          <NavElement
            ...
            navigationStarts={() => setIsNavOpen(false)}
          /> */}
            <WalletMultiButtonDynamic className="button btn-sm rounded-btn text-lg mr-6 " />
          </div>
          {/* <label
              htmlFor="my-drawer"
